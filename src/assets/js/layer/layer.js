! function(e) {
	...
	d.prototype.view = function() {
		...
		if (n.fixed || (n.top = n.hasOwnProperty("top") ? n.top : 100, n.style = n.style || "", n.style += " top:" + (t.body.scrollTop + n.top) + "px"), 2 === n.type && (n.content = '<section class="m-loading-ka"></div></section>'), n.skin && (n.anim = "up"), "msg" === n.skin && (n.shade = !1), a.innerHTML = (n.shade ? "<div " + ("string" == typeof n.shade ? 'style="' + n.shade + '"' : "") + ' class="layui-m-layershade"></div>' : "") + '<div class="layui-m-layermain" ' + (n.fixed ? "" : 'style="position:static;"') + '><div class="layui-m-layersection"><div class="layui-m-layerchild ' + (n.skin ? "layui-m-layer-" + n.skin + " " : "") + (n.className ? n.className : "") + " " + (n.anim&&n.type!=1 ? "layui-m-anim-" + n.anim : "") + '" ' + (n.style ? 'style="' + n.style + '"' : "") + ">" + (n.skin==="msg" ? msgSkin : l) + '<div class="layui-m-layercont">' + n.content + "</div>" + d + "</div></div></div>", !n.type || 2 === n.type) {
		...
		close: function(e) {
			var n = s("#" + o[0] + e)[0];
			n && (n.innerHTML = "", document.body.removeChild(n), clearTimeout(l.timer[e]), delete l.timer[e], "function" == typeof l.end[e] && l.end[e](), delete l.end[e])
		},
		closeAll: function() {
